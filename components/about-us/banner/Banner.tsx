        ...
        <div className={styles.banner}>
            ...
            <div className={styles.card}>
                <div className={styles.content}>
                    ...
                    transportation solution. We can help improve service to clients while minimizing the amount of money
                    ...
                    <br />
                    <br />
                    Supply chains and the trucking industry are changing and most companies have limited resources and
